...
// The Firebase configuration will be automatically injected by the Firebase CLI during deployment.
// Running the app locally will use the demo project configuration.
