...
const allLinks = [
  ...
  { href: '/dashboard/integrations', label: 'Integrations', icon: Layers, permission: 'settings:integrations' },
  { href: '/dashboard/help', label: 'Help', icon: LifeBuoy, permission: 'help:view' },
  { 
    label: 'Settings', 
    icon: Settings, 
    permissions: ['settings:general', 'settings:workflow', 'settings:departments', 'settings:roles', 'settings:budget', 'settings:auditlog', 'settings:errorlog', 'settings:procurement-periods', 'settings:data', 'settings:email'],
    subLinks: [
