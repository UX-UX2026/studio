...
const allLinks = [
  ...
  { 
    label: 'Settings', 
    icon: Settings, 
    permissions: ['settings:general', 'settings:workflow', 'settings:departments', 'settings:roles', 'settings:budget', 'settings:integrations', 'settings:auditlog', 'settings:errorlog', 'settings:procurement-periods', 'settings:data'],
    subLinks: [
