...
const allLinks = [
  ...
  { 
    label: 'Settings', 
    icon: Settings, 
    permissions: ['settings:general', 'settings:workflow', 'settings:departments', 'settings:roles', 'settings:budget', 'settings:integrations', 'settings:auditlog', 'settings:errorlog', 'settings:procurement-periods', 'settings:data', 'settings:email'],
    subLinks: [
        ...
        { href: '/dashboard/settings/odoo-integration', label: 'Odoo Integration', icon: Layers, permission: 'settings:integrations', iconClass: "text-emerald-500" },
