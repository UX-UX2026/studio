...
export const fulfillmentItems = [
  ...
  },
  {
    ...
    qty: 10,
    receivedQty: 5,
    comments: ["Procurement Officer: Partial delivery received. 5 chairs on backorder. ETA is 2 weeks."],
  ...
  },
  {
    ...
    qty: 1,
    receivedQty: 1,
    comments: ["Procurement Officer: Project completed and delivered."],
