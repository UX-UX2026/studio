export const mockUsers = [
    ...
    { id: '7', name: 'Executive User', email: 'ex@procurportal.com', role: 'Executive', department: 'Executive', avatar: '' },
    { id: '8', name: 'Procurement User', email: 'proc@procurportal.com', role: 'Procurement Officer', department: 'Procurement', avatar: '' },
    { id: '9', name: 'Procurement Assistant User', email: 'proca@procurportal.com', role: 'Procurement Assistant', department: 'Procurement', avatar: '' }
];
